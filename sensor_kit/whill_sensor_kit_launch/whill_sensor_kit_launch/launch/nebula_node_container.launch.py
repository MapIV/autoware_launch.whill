...
def launch_setup(context, *args, **kwargs):
    ...
    if sensor_extension is not None:  # Velodyne and Hesai
        ...
        print("sensor_calib_fp: ", sensor_calib_fp)
...
def generate_launch_description():
    ...
    add_launch_arg("cut_angle", "0.0", "xxxxxxx")
    add_launch_arg("sync_angle", "0", "xxxxxxx")
    ...
    add_launch_arg("retry_hw", "True", "xxxxx")
    add_launch_arg("diag_span", "1000", "xxxxx")
    add_launch_arg(
